...
require.m = [];
require.m[0] = { "sax": {"c":1,"m":"/lib/sax.js"}};
require.m[1] = { "/examples/example.js": function(module, exports, require){
var fs = require("fs"),
  util = require("util"),
  path = require("path"),
...
"/examples/get-products.js": function(module, exports, require){// pull out /GeneralSearchResponse/categories/category/items/product tags
...
"/examples/hello-world.js": function(module, exports, require){require("http").createServer(function (req, res) {
  res.writeHead(200, {"content-type":"application/json"})
  res.end(JSON.stringify({ok: true}))
}).listen(1337)
},
"/examples/pretty-print.js": function(module, exports, require){var sax = require("../lib/sax")
...
"/examples/switch-bench.js": function(module, exports, require){#!/usr/local/bin/node-bench
...
"/lib/sax.js": function(module, exports, require){// wrapper for non-node envs
;(function (sax) {
